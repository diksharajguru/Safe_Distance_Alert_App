                        ...
                        if(task.isSuccessful()) {
                            ...
                            documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(RegisterAdmin.this, "Admin created", Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Intent intent = new Intent(RegisterAdmin.this, Employee.class);
                                    startActivity(intent);
                                }
                            });
                        } else{
                            Toast.makeText(RegisterAdmin.this, "Failed to register", Toast.LENGTH_LONG).show();
                            progressBar.setVisibility(View.INVISIBLE);
                        }
                    }
                });
